...
{
    public class SetArena : IConfigVariables
    {
        public ConfigCommandEnum CommandName => ConfigCommandEnum.SetArena;
        ...
        public void Execute(string value)
        {
            ...
            ArenaManager.StageArena(corner1, corner2, true);
            Logger.Log($"Set default arena to: ({x1:F2}, {z1:F2}) -> ({x2:F2}, {z2:F2})", LogLevel.INFO);
        }
    }
}
