...
{
    // A planar snapshot of a bot's pose, taken fresh each tick from its transform. This is Millington's "static"
    // data, position and orientation. We omit velocity and angular velocity because the engine owns inertia and
    // turn rate: the AI commands a desired velocity directly rather than building it up through accelerations.
    //
